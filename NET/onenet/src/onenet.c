...
#define AUTH_INFO	"smarthome_zuijiandan"

#define DEVID		"smarthome_00000001"
	...
	switch(type)
	{
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				{
					json_value = cJSON_GetObjectItem(json, "LED_SW");		//MQTTFX 上Publish上订阅/timedisplay/sub  发送{"LED_SW":0}   LED灯亮
